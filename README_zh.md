...
<h2 align="center"> XSafeClaw：监控并保护你的智能体 🚀 </h2>
...
<h2 align="center">🔥🔥 现已支持 OpenClaw、Hermes 和 Nanobot！🔥🔥</h2>
...
|      | 日期       | 更新                                                         |
| :--: | :--------- | :----------------------------------------------------------- |
|  🔥  | 2026-06-12 | v1.1.1 发布并已上传至 PyPI — 优化 Agent Town 任务界面、OpenClaw 配置与 gateway 连接稳定性，完善重置清理、会话标签、标题展示、Smart Router 标签处理和后端页面视觉效果。 |
|  🔥  | 2026-06-10 | v1.1.0 发布并已上传至 PyPI — Runtime Guard 完善审批请求展示与 Hermes 会话上下文守卫覆盖，新增智能体推荐、预算控制，并优化后端页面与 Agent Valley 视觉体验。 |
